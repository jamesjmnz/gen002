    ...
    >
      <div className="flex items-center pointer-events-none">
        <svg
          ...
          strokeWidth="1"
          viewBox="0 0 16 16"
          className="h-6 w-6 -rotate-[70deg] transform stroke-black text-black drop-shadow-lg pointer-events-none" /* changed to black from orange */
          height="1em"
          width="1em"
        ...
        <motion.div
          style={{
            backgroundColor: "#000000" /* changed to black from orange */,
          }}
          initial={{
            scale: 0.5,
            opacity: 0,
