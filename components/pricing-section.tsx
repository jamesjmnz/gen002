          ...
          >
            <button
              ...
              className={`px-6 py-2 rounded-full text-sm font-medium transition-all duration-200 ${
                !isAnnual ? "bg-black text-white shadow-lg" : "text-white/60 hover:text-white/80"
              }`}
            >
              Monthly
            </button>
          ...
          {pricingPlans.map((plan, index) => (
            <motion.div
              ...
              className={`relative rounded-2xl p-8 backdrop-blur-sm border transition-all duration-300 ${
                plan.popular
                  ? "bg-gradient-to-b from-black/10 to-transparent border-black/30 shadow-lg shadow-black/10"
                  : "bg-white/5 border-white/10 hover:border-white/20"
              }`}
            >
              {plan.popular && (
                <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                  <div className="bg-gradient-to-r from-black to-black/80 text-white text-sm font-medium px-4 py-2 rounded-full">
                    Most Popular
                  </div>
                </div>
              )}
              ...
              <motion.button
                ...
                className={`w-full py-3 px-6 rounded-lg font-medium transition-all duration-200 ${
                  plan.popular
                    ? "bg-gradient-to-r from-black to-black/80 text-white shadow-lg shadow-black/25 hover:shadow-black/40"
