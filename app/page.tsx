  ...
  const teamMembers = [
    {
      ...
      role: "Lead Developer",
      img: james.src,
      selfCare: "Music & coffee breaks",
    },
    {
      name: "Queen Ynah D. Suratos",
      role: "Data Analyst",
      img: ynah.src,
      selfCare: "Reading & watching shows",
    },
    {
      name: "Kenneth E. Peralta",
      role: "Researcher",
      img: kenneth.src,
      selfCare: "Gaming & creative projects",
    },
    {
      name: "Christian Emmanuel Moreno",
      role: "Researcher",
      img: christian.src,
      selfCare: "Basketball & trying new food",
    },
    {
      name: "Charles Laurence Erasquin",
      role: "Researcher",
      img: charles.src,
      selfCare: "Music & online content",
    },
    {
      name: "Xander Castro",
      role: "Researcher",
      img: xander.src,
      selfCare: "Exercise & staying active",
    },
    {
      name: "Daryl Narvasa",
      role: "Researcher",
      img: daryl.src,
      selfCare: "Cooking & learning new recipes",
    },
    {
      name: "CJ Llarenas",
      role: "Researcher",
      img: cj.src,
      selfCare: "Rest & exploring hobbies",
    },
    {
      name: "Ronnie Rullan",
      role: "Data Researcher",
      img: ronnie.src,
      selfCare: "Reading & quiet time",
    },
    {
      name: "Patricia Gomez",
      role: "Community Manager",
      img: "https://images.unsplash.com/photo-1438761681033-6461ffad8d80?w=400&h=300&fit=crop&crop=face",
      selfCare: "Socializing & connecting with others",
    },
  ]
